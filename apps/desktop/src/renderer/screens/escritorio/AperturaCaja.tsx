  ...
  if (paso === "stock") {
    return (
      <div className="p-6 max-w-4xl mx-auto">
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-on-surface">Stock Inicial del Día</h1>
      ...
      <div className="max-w-md mx-auto">
        <div className="bg-surface-container-lowest rounded-2xl p-6 shadow-sm border border-outline-variant">
          ...
          <div className="space-y-4 mb-6">
            ...
            <div className="p-4 bg-surface-container rounded-xl">
              <p className="text-sm text-on-surface-variant">Hora de apertura</p>
              <p className="font-medium text-on-surface">
            ...
            <div className="p-4 bg-surface-container rounded-xl">
              <p className="text-sm text-on-surface-variant">Cajero</p>
            ...
            <div className="mb-4 p-3 bg-error-container text-on-error-container rounded-xl text-center">
              ...
              {sesionStale && (
                <button
                  ...
                  disabled={loading}
                  className="mt-3 px-4 py-2 bg-error text-on-error rounded-lg hover:bg-error/90 disabled:opacity-50 transition-colors text-sm"
                >
